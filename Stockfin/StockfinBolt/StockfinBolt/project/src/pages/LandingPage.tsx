  ...
  export function LandingPage({ onLogin }: { onLogin: () => void }) {
    ...
    const createGameSession = async () => {
      try {
        ...
        // Call to Python backend to create a session
        const response = await fetch('/api/create-session', {
          ...
          body: JSON.stringify({
            // Add any parameters needed for session creation
        ...
        if (response.ok) {
          ...
          // You might want to redirect to the game session page
          // or store the session ID in state
        } else {
        ...
        <div className="relative overflow-hidden">
          ...
          <nav className="relative z-10 px-6 py-4 flex justify-between items-center border-b border-cyan-500/20">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                {isCreatingSession ? 'Creating...' : 'Enter Session'}
                {!isCreatingSession && <ChevronRight className="w-4 h-4" />}
              </button>
              <button
            ...
            <div className="md:w-1/2 max-w-md w-full">
              <div className="bg-black/80 neon-border p-6 rounded-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-cyan-600 to-cyan-400 hover:from-cyan-500 hover:to-cyan-300 text-black font-bold py-3 rounded-lg transition-all mt-4"
                  >
